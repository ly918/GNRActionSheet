...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GNRActionSheet.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ly918@qq.com/GNRActionSheet'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ly918@qq.com' => 'ly918@qq.com' }
  s.source           = { :git => 'https://github.com/ly918@qq.com/GNRActionSheet.git', :tag => s.version.to_s }
